...
- [gateway-launcher-rewrite-stage3-upstream-D5.md](./gateway-launcher-rewrite-stage3-upstream-D5.md) — Gateway launcher rewrite Stage 3 owner handoff for the upstream Gateway static asset route
