 ...
 */
export function ModelDetail({ model, auth, onSetDefault, onAddToFallback }: ModelDetailProps) {
    ...
    <div className="transition-panel space-y-6 p-6">
      ...
      <div>
        ...
        <div className="mt-1 flex items-center gap-3 text-xs text-[var(--text-secondary)]">
          ...
          <span className="font-mono text-[10px] text-[var(--text-secondary)]">{model.id}</span>
        </div>
      </div>
