...
import { getChannelAccessDescriptor } from "./channel-access-registry";
...
export function ChannelAccessTab({
  ...
  const descriptor = getChannelAccessDescriptor(channelId);
        ...
        {accessModel.accountIds.length > 1 && (
          <>
            ...
            >
              ...
              >
                <SelectTrigger className="w-full max-w-sm text-xs bg-[var(--background)] border-[var(--border)] cursor-pointer">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
