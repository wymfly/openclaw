import type { DecayableMemory } from "./decay-engine-types.js";
import {
...
export function buildSmartMetadata(
  ...
  const nextCategory =
    typeof patch.memory_category === "string" ? patch.memory_category : base.memory_category;
  ...
  return {
    ...
    supersedes:
      patch.supersedes === undefined ? base.supersedes : normalizeOptionalString(patch.supersedes),
    superseded_by:
      patch.superseded_by === undefined
        ? base.superseded_by
        : normalizeOptionalString(patch.superseded_by),
    source_session:
      typeof patch.source_session === "string" ? patch.source_session : base.source_session,
  };
}
