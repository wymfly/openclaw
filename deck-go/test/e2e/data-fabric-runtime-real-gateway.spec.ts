...
import { openDeck, startRealGatewayStack, type E2EStack } from "./helpers";

test.describe("Data Fabric runtime summary cache against real Gateway", () => {
  test.skip(
  ...
  test("keeps runtime summary cached across real-stack panel navigation", async ({ page }) => {
