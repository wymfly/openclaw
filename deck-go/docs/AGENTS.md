...
>
> - **本文件** (`docs/AGENTS.md`) — 项目文档导航；先读这里
> - [`../frontend-new/AGENTS.md`](../frontend-new/AGENTS.md) — 真实工程协议（Claude Code 在新工程区的工作约定，**新工作落这里**）
> - [`../frontend-handoff/AGENTS.md`](../frontend-handoff/AGENTS.md) — 双 agent 协作协议（设计 Agent 与 Claude Code 协作的契约）
>
> 老入口（已冻结）：
>
> - [`../frontend/AGENTS.md`](../frontend/AGENTS.md) — ⚠️ **frozen**；新工作转到 `frontend-new/AGENTS.md`
>
> **解耦的支撑文档（AGENTS.md 链接它们而不嵌入项目细节）：**
>
...
│   ├── e2e-stack-operations.md      · mock/real Gateway 调试栈与 Playwright E2E 矩阵
...
| [`project/e2e-stack-operations.md`](./project/e2e-stack-operations.md)                                   | mock Gateway 与真实 OpenClaw Gateway 的调试栈、env 文件、状态目录、Make targets 和 Playwright E2E 命名矩阵。启动或排查 E2E 前先看这份。                                                                                             |
...
详细协议见 [`../frontend-handoff/AGENTS.md`](../frontend-handoff/AGENTS.md)。
