        ...
        return (
          ...
          >
            ...
            <div className="flex items-center gap-2 min-w-0">
              ...
              <span className="text-xs font-medium truncate" title={session.label ?? session.key}>
            ...
            {session.label?.trim() && (
              <span
                className="text-[10px] font-mono truncate text-[var(--muted-foreground)]"
                title={session.key}
              >
