...
import { createContext, useCallback, useEffect, useLayoutEffect, useMemo, useState, useRef } from "react";
...
export function ChatPanel() {
  ...
  // Reset right-panel state before paint on session switches so a quick
  // canvas toggle click is not overwritten by the trailing session-reset effect.
  useLayoutEffect(() => {
    setRightPanelMode("hidden");
