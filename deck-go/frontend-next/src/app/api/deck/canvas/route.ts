...
async function localDeckCanvasPostHandler(request: NextRequest): Promise<Response> {
...
const guardedLocalDeckCanvasPostHandler = withAuth(localDeckCanvasPostHandler);
...
export async function POST(request: NextRequest): Promise<Response> {
  ...
  return guardedLocalDeckCanvasPostHandler(request);
}
