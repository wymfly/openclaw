...
async function localSettingsTestConnectionHandler(request: NextRequest) {
...
const guardedLocalSettingsTestConnectionHandler = withAuth(localSettingsTestConnectionHandler);
...
export async function POST(request: NextRequest) {
  ...
  return guardedLocalSettingsTestConnectionHandler(request);
}
