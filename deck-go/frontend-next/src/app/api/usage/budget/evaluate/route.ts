...
async function localBudgetEvaluateGetHandler(_request: NextRequest) {
...
const guardedLocalBudgetEvaluateGetHandler = withAuth(localBudgetEvaluateGetHandler);
...
export async function GET(request: NextRequest) {
  ...
  return guardedLocalBudgetEvaluateGetHandler(request);
}
