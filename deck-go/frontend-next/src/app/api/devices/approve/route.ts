...
async function localDevicesApprovePostHandler(request: NextRequest) {
...
const guardedLocalDevicesApprovePostHandler = withAuth(localDevicesApprovePostHandler);
...
export async function POST(request: NextRequest) {
  ...
  return guardedLocalDevicesApprovePostHandler(request);
}
