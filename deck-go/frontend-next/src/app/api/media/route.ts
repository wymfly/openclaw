...
async function localMediaGetHandler(request: NextRequest) {
...
const guardedLocalMediaGetHandler = withAuth(localMediaGetHandler);
...
export async function GET(request: NextRequest) {
  ...
  return guardedLocalMediaGetHandler(request);
}
