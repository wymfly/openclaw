...
> **Sibling protocol entries:** [`../docs/AGENTS.md`](../docs/AGENTS.md)（项目导航）· [`../frontend-new/AGENTS.md`](../frontend-new/AGENTS.md)（真实工程协议）
>
