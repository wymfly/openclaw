...
| Reviewer                       | Codex                                                                                                                           |
| Date                           | 2026-05-06                                                                                                                      |
| Prototype reference            | `frontend-handoff/modules/identity/prototype.html`                                                                              |
| Production reference           | `frontend-new/src/components/panels/identity/`                                                                                  |
| Mock functional evidence       | `frontend-handoff/audit/module-evidence-manifest.json` (`identity`, `mock-functional`, verdict: `recorded-by-visual-spec`)      |
| Mock prototype parity evidence | `frontend-handoff/audit/module-evidence-manifest.json` (`identity`, `mock-prototype-parity`, verdict: `unreviewed`)             |
| Real Gateway evidence          | `frontend-handoff/audit/module-evidence-manifest.json` (`identity`, `real-gateway`, status: `recorded-in-implementation-notes`) |
| Accepted exceptions            | See `frontend-handoff/audit/module-evidence-manifest.json` and `frontend-handoff/modules/identity/implementation-notes.md`.     |
