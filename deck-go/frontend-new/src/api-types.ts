...
export type DeckGoModelSecretRef = DeckApi.DeckGoModelSecretRef;
...
export type DeckGoModelBooleanToggleAction = DeckApi.DeckGoModelBooleanToggleAction;
...
export type DeckGoModelReferenceRelation = DeckApi.DeckGoModelReferenceRelation;
...
export type DeckGoAgentEffectiveSource = DeckApi.DeckGoAgentEffectiveSource;
export type DeckGoAgentEffectiveField = DeckApi.DeckGoAgentEffectiveField;
export type DeckGoAgentInheritanceMap = DeckApi.DeckGoAgentInheritanceMap;
export type DeckGoAgentImpactSummary = DeckApi.DeckGoAgentImpactSummary;
export type DeckGoAgentUnresolvedReferences = DeckApi.DeckGoAgentUnresolvedReferences;
...
export type DeckGoAgentModelPolicyTargetKind = DeckApi.DeckGoAgentModelPolicyTargetKind;
export type DeckGoAgentModelPolicyShape = DeckApi.DeckGoAgentModelPolicyShape;
export type DeckGoAgentModelPolicySource = DeckApi.DeckGoAgentModelPolicySource;
export type DeckGoAgentModelPolicyOwner = DeckApi.DeckGoAgentModelPolicyOwner;
export type DeckGoAgentModelSelection = DeckApi.DeckGoAgentModelSelection;
export type DeckGoAgentModelPolicyTarget = DeckApi.DeckGoAgentModelPolicyTarget;
export type DeckGoAgentModelChoice = DeckApi.DeckGoAgentModelChoice;
export type DeckGoAgentModelPolicyEntry = DeckApi.DeckGoAgentModelPolicyEntry;
export type DeckGoAgentUnsupportedModelPolicy = DeckApi.DeckGoAgentUnsupportedModelPolicy;
export type DeckGoAgentModelPolicyResponse = DeckApi.DeckGoAgentModelPolicyResponse;
export type DeckGoAgentModelPolicySetResponse = DeckApi.DeckGoAgentModelPolicySetResponse;
...
export type DeckGoAgentCognitionGetRequest = DeckApi.DeckGoAgentCognitionGetRequest;
export type DeckGoAgentCognitionSetRequest = DeckApi.DeckGoAgentCognitionSetRequest;
export type DeckGoAgentWorkspaceGetRequest = DeckApi.DeckGoAgentWorkspaceGetRequest;
export type DeckGoAgentWorkspaceSetRequest = DeckApi.DeckGoAgentWorkspaceSetRequest;
export type DeckGoAgentConversationGetRequest = DeckApi.DeckGoAgentConversationGetRequest;
export type DeckGoAgentConversationSetRequest = DeckApi.DeckGoAgentConversationSetRequest;
export type DeckGoAgentDeliveryGetRequest = DeckApi.DeckGoAgentDeliveryGetRequest;
export type DeckGoAgentDeliverySetRequest = DeckApi.DeckGoAgentDeliverySetRequest;
export type DeckGoAgentToolsOverrideGetRequest = DeckApi.DeckGoAgentToolsOverrideGetRequest;
export type DeckGoAgentToolsOverrideSetRequest = DeckApi.DeckGoAgentToolsOverrideSetRequest;
export type DeckGoAgentDefaultsBucket = DeckApi.DeckGoAgentDefaultsBucket;
export type DeckGoAgentDefaultsGetRequest = DeckApi.DeckGoAgentDefaultsGetRequest;
export type DeckGoAgentDefaultsSetRequest = DeckApi.DeckGoAgentDefaultsSetRequest;
