...
#### Scenario: Batch C migration completes

- **WHEN** Webhooks, Cron, and Approvals cockpit rollout changes finish
  implementation and verification
- **THEN** the cockpit rollout readiness matrix SHALL mark those panels as
  migrated or partially migrated by
  `deck-go-cockpit-rollout-batch-c-automation-guarded-writes`
