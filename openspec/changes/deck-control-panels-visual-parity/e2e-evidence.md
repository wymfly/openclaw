...
- Run the Playwright MCP route/mode matrix for Budget, Alerts, Channels,
  Plugins, Routing, Subagents, Identity, Config, Nodes, Docs, and Settings, and
  save the required screenshots plus console review artifacts.
