...
#### Scenario: Batch B migration completes

- **WHEN** Identity, Subagents, and Channels cockpit rollout changes finish
  implementation and verification
- **THEN** the cockpit rollout readiness matrix SHALL mark those panels as
  migrated or partially migrated by
  `deck-go-cockpit-rollout-batch-b-relationship-runtime`
