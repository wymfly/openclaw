...
- Strengthen real Gateway evidence so module checks cover shell navigation,
  light/dark mode, Chinese/English locale, child page interactions, and
  run-scoped real fixture data whenever the Gateway-backed state can be created
