# frontend-config-real-contract-verification Specification

## Purpose

TBD - created by archiving change frontend-config-real-contract-verification. Update Purpose after archive.
