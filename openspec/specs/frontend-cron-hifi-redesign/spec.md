# frontend-cron-hifi-redesign Specification

## Purpose

Defines the high-fidelity, contract-backed Cron redesign for Deck BFF/Gateway scheduled-job control, inventory filtering, selected job evidence, builder actions, guarded deletion, run history, scheduler status, mock/local visual verification, and design-system rollout evidence.
