...
Complete the Deck Go Nodes contract-chain so node inventory, command invocation,
pending work, pairing actions, dynamic command payload boundaries, mutation
evidence, and durable matrix evidence stay aligned with current Gateway and
Deck code truth.
