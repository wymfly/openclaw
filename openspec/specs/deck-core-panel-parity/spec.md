...
Track production visual and interaction parity for the migrated Vite Core deck panels against the old Deck client while preserving Gateway-backed capability boundaries.
