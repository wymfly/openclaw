# frontend-gateway-real-contract-verification Specification

## Purpose

TBD - created by archiving change frontend-gateway-real-contract-verification. Update Purpose after archive.
