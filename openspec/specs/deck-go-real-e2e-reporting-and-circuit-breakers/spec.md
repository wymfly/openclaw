# deck-go-real-e2e-reporting-and-circuit-breakers Specification

## Purpose

Define shared Deck Go real E2E evidence reporting rules, including bounded statuses, retry metadata, and handoff-friendly blocker records.
