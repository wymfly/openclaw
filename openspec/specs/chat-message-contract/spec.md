...
- **scenario_id**: `chat-message-contract.history-plain-text`
...
- **scenario_id**: `chat-message-contract.session-message-history-parity`
...
- **scenario_id**: `chat-message-contract.alias-block-normalization`
...
- **scenario_id**: `chat-message-contract.image-file-preserved`
...
- **scenario_id**: `chat-message-contract.session-tool-structured-result`
...
- **scenario_id**: `chat-message-contract.history-tool-result-structured`
