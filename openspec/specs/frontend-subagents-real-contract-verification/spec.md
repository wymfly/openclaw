# frontend-subagents-real-contract-verification Specification

## Purpose

Defines the Subagents module's real-contract verification requirements across OpenClaw Gateway, deck-go Go BFF routes, Deck-facing DTOs, frontend wrappers, mock visual testing, bounded real-stack testing, and archive readiness.
