...
The production threads panel SHALL render and operate from contract-backed thread inventory data while preserving the existing panel registry and API facade boundaries.
