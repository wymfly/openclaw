...
Capture the completed Docs and Memory contract-chain closure for Deck Go: Docs
extract/delete action evidence is typed, Memory search degraded semantics are
explicit, and remaining semantic-search, docs-policy, and mutating-memory limits
stay visible.
