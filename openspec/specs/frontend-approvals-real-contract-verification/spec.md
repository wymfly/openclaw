# frontend-approvals-real-contract-verification Specification

## Purpose

Defines Approvals-specific real-contract verification, Gateway/BFF route-chain safety, deterministic drift handling, mock visual coverage, bounded real-stack evidence, and gated backend/dependency expansion.
