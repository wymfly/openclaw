...
Capture the completed Budget, Alerts, and Webhooks contract-chain closure for
Deck Go: current workflows remain Deck-local control surfaces, deterministic
Budget/Webhooks DTO and mutation evidence drift is fixed, and unsupported
forecast/history/retry leaves remain explicit.
