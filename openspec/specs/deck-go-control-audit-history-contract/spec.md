# deck-go-control-audit-history-contract Specification

## Purpose

Define Deck Go product-level control audit history for authenticated mutation metadata, including retention rules, typed DTOs, and a Deck BFF read route.
