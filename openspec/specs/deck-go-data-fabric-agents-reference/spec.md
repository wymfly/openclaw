# deck-go-data-fabric-agents-reference Specification

## Purpose

Define Agents as the first business-module reference migration onto the
`frontend-new` Data Fabric. This capability captures contract-sourced Agents
reads, explicit query keys/freshness, mutation safety, live projection
invalidation, and mock/real verification expectations for later module
migrations.
