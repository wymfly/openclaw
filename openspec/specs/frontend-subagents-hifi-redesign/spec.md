...
Defines the contract-led high-fidelity redesign for the Deck Go `subagents` frontend module, including handoff package, production workbench, BFF query forwarding, mock visual verification, and design-system feedback.
