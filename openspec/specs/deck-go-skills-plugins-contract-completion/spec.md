...
Capture the completed Skills and Plugins contract-chain closure for Deck Go:
Skills product DTOs are narrowed, Skills writes are mutation-evidence known,
Plugins has no accidental dynamic DTO leaves, and remaining workspace-write plus
plugin lifecycle/trust limits stay visible.
