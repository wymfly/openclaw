...
Define the product-level contract closure requirements for Deck Go Chat and
Sessions workflows after list-query, live projection, real seed, and mutation
evidence platform contracts are available.
