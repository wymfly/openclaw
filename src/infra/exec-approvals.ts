...
const DEFAULT_SOCKET_NAME = "exec-approvals.sock";
const DEFAULT_FILE_NAME = "exec-approvals.json";
...
export function resolveExecApprovalsPath(): string {
  return path.join(resolveStateDir(), DEFAULT_FILE_NAME);
}

export function resolveExecApprovalsSocketPath(): string {
  return path.join(resolveStateDir(), DEFAULT_SOCKET_NAME);
}
